---
trigger: always_on
description: "Performance-first coding mindset for all changes"
---
...
- Use memoization where computation is expensive and inputs are stable
- Prefer streaming/chunked responses for large data sets
